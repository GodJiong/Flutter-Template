...
203.4 [learn more](https://www.jetbrains.org/intellij/sdk/docs/basics/getting_started/build_number_ranges.html)
...
- Manually:
  ...
  Download the [latest release](https://github.com/GodJiong/Flutter-Template/releases/latest) and install it manually
  using
...
|-----------------------|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| `gs`                  | GetX StatefulWidget      | Creates an StatefulWidget with GetX.                                                                                                                                                                                                      | [View Docs](https://pub.dev/packages/get)                                                 |
